...
fase_4_1:		incbin	"FASE_4_1_pletter.dat"
fase_4_2:		incbin	"FASE_4_2_pletter.dat"
fase_5_1:		incbin	"FASE_5_1_pletter.dat"
fase_5_2:		incbin	"FASE_5_2_pletter.dat"
fase_6:			incbin	"FASE_6_pletter.dat"
fase_7_1:		incbin	"FASE_7_1_pletter.dat"
fase_7_2:		incbin	"FASE_7_2_pletter.dat"
fase_8:			incbin	"FASE_8_pletter.dat"
fase_9:			incbin	"FASE_9_pletter.dat"
fase_10_1:		incbin	"FASE_10_1_pletter.dat"
fase_10_2:		incbin	"FASE_10_2_pletter.dat"
fase_11_1:		incbin	"FASE_11_1_pletter.dat"
fase_11_2:		incbin	"FASE_11_2_pletter.dat"
fase_12:		incbin	"FASE_12_pletter.dat"
fase_13:		incbin	"FASE_13_pletter.dat"
fase_14:		incbin	"FASE_14_pletter.dat"
fase_15_1:		incbin	"FASE_15_1_pletter.dat"
fase_15_2:		incbin	"FASE_15_2_pletter.dat"
fase_16:		incbin	"FASE_16_pletter.dat"
...
bloque_sanctuary_4:
		...
		ld		a,(idioma)												;anunciamos sanctuary 12
		or		a
...
bloque_sanctuary_4_cont:
		...
		ld		hl,fase_12												;cargamos sanctuary 12 en ram
		ld		de,buffer_colisiones
		call	depack
...
bloque_sanctuary_5_cont:
		...
		ld		hl,fase_18												;cargamos sanctuary 18 en ram
		ld		de,buffer_colisiones
		call	depack
...
bloque_sanctuary_6_cont:
		...
		ld		hl,fase_14												;cargamos sanctuary 2 en ram
		ld		de,buffer_colisiones
		call	depack
...
bloque_sanctuary_7_cont:
		...
		ld		hl,fase_5_1												;cargamos sanctuary 4 en ram
		ld		de,buffer_colisiones
		call	depack
		
		ld		hl,fase_5_2												;cargamos sanctuary 4 en ram la parte 2
...
bloque_sanctuary_8_cont:
		...
		ld		hl,fase_4_1												;cargamos sanctuary 4 en ram
		ld		de,buffer_colisiones
		call	depack
		
		ld		hl,fase_4_2												;cargamos sanctuary 4 en ram la parte 2
		ld		de,buffer_colisiones_2
		call	depack
...
bloque_sanctuary_9:
		...
		ld		a,(idioma)												;anunciamos sanctuary 13
		or		a
...
bloque_sanctuary_9_cont:
		...
		;		variables grifos balsa
		
		ld		hl,717
		ld		(tile_grifo_balsa_1),hl
		ld		hl,723
		ld		(tile_grifo_balsa_2),hl
		ld		hl,528
		ld		(posicion_balsa_desde_grifo),hl
		ld		a,1
		ld		(balsa_activa),a
		...
		ld		hl,fase_13												;cargamos sanctuary 13 en ram
		ld		de,buffer_colisiones
		call	depack
		...
		call	pantalla_en_mas_blanco
		
		ld		de,#1877
		call	pinta_mando_de_luz_en_su_sitio
...
bloque_sanctuary_10:
		...
		ld		a,(idioma)												;anunciamos sanctuary 11
		or		a
...
bloque_sanctuary_10_cont:
		...
		ld		hl,fase_15_1											;cargamos sanctuary 11 en ram
		ld		de,buffer_colisiones
		call	depack
		
		ld		hl,fase_15_2											;cargamos sanctuary 11 en ram la parte 2
		ld		de,buffer_colisiones_2
		call	depack
...
bloque_sanctuary_11:
		...
		ld		a,(idioma)												;anunciamos sanctuary 13
		or		a
		jr.		z,bloque_sanctuary_11_esp
		ld		hl,sanctuary_x
		jr.		bloque_sanctuary_11_cont

bloque_sanctuary_11_esp:

		ld		hl,santuario_x

bloque_sanctuary_11_cont:
		...
		ld		hl,fase_16												;cargamos sanctuary 13 en ram
		ld		de,buffer_colisiones
		call	depack
...
bloque_sanctuary_12:
		...
		ld		a,(idioma)												;anunciamos sanctuary 1
		or		a
		jr.		z,bloque_sanctuary_12_esp
		ld		hl,sanctuary_x
		jr.		bloque_sanctuary_12_cont

bloque_sanctuary_12_esp:

		ld		hl,santuario_x

bloque_sanctuary_12_cont:
		...
		ld		hl,fase_17												;cargamos sanctuary 2 en ram
		ld		de,buffer_colisiones
		call	depack
...
bloque_sanctuary_13:
		...
		or		a
		jr.		z,bloque_sanctuary_13_esp
		ld		hl,sanctuary_x
		jr.		bloque_sanctuary_13_cont

bloque_sanctuary_13_esp:

		ld		hl,santuario_x

bloque_sanctuary_13_cont:
...
bloque_sanctuary_14:
		...
		or		a
		jr.		z,bloque_sanctuary_14_esp
		ld		hl,sanctuary_x
		jr.		bloque_sanctuary_14_cont

bloque_sanctuary_14_esp:

		ld		hl,santuario_x

bloque_sanctuary_14_cont:
		...
		ld		hl,fase_7_1												;cargamos sanctuary 7 en ram
		ld		de,buffer_colisiones
		call	depack
		
		ld		hl,fase_7_2												;cargamos sanctuary 7 en ram
		ld		de,buffer_colisiones_2
		call	depack
...
bloque_sanctuary_15:
		...
		ld		a,(idioma)												;anunciamos sanctuary 8
		or		a
		jr.		z,bloque_sanctuary_15_esp
		ld		hl,sanctuary_x
		jr.		bloque_sanctuary_15_cont

bloque_sanctuary_15_esp:

		ld		hl,santuario_x

bloque_sanctuary_15_cont:
...
bloque_sanctuary_16:
		...
		or		a
		jr.		z,bloque_sanctuary_16_esp
		ld		hl,sanctuary_x
		jr.		bloque_sanctuary_16_cont

bloque_sanctuary_16_esp:

		ld		hl,santuario_x

bloque_sanctuary_16_cont:
		...
		ld		hl,fase_9												;cargamos sanctuary 9 en ram
		ld		de,buffer_colisiones
		call	depack
...
bloque_sanctuary_17:
		...
		or		a
		jr.		z,bloque_sanctuary_17_esp
		ld		hl,sanctuary_x
		jr.		bloque_sanctuary_17_cont

bloque_sanctuary_17_esp:

		ld		hl,santuario_x

bloque_sanctuary_17_cont:
		...
		ld		hl,fase_10_1											;cargamos sanctuary 10 en ram
		ld		de,buffer_colisiones
		call	depack
		
		ld		hl,fase_10_2											;cargamos sanctuary 4 en ram la parte 2
		ld		de,buffer_colisiones_2
		call	depack
...
bloque_sanctuary_18:
		...
		ld		a,(idioma)												;anunciamos sanctuary 11
		or		a
		jr.		z,bloque_sanctuary_18_esp
		ld		hl,sanctuary_x
		jr.		bloque_sanctuary_18_cont

bloque_sanctuary_18_esp:

		ld		hl,santuario_x

bloque_sanctuary_18_cont:
		...
		ld		hl,fase_11_1											;cargamos sanctuary 11 en ram
		ld		de,buffer_colisiones
		call	depack
		
		ld		hl,fase_11_2											;cargamos sanctuary 11 en ram la parte 2
		ld		de,buffer_colisiones_2
		call	depack
...
;		ld		a,(idioma)												;anunciamos sanctuary 8
;		cp		0
;		jr.		z,bloque_sanctuary_19_esp
;		ld		hl,sanctuary_x
;		jr.		bloque_sanctuary_19_cont

;bloque_sanctuary_19_esp:

;		ld		hl,santuario_x

;bloque_sanctuary_19_cont:
...
;		ld		hl,fase_17												;cargamos sanctuary 8 en ram
;		ld		de,buffer_colisiones
;		call	depack
...
FINAL_TEMPLO:
		...
		ld		hl,TILES_FINAL											;cargamos patrones
		ld		de,#0000
		call	depack_VRAM
		
		ld		hl,COLOR_FINAL											;cargamos colores de patrones
		ld		de,#2000
		call	depack_VRAM
		...
		ld		hl,FINAL_ING											;carga PANTALLA
		ld		de,#1800
		call	depack_VRAM
		call	recbios
		ei
		
		jr.		FINAL_TEMPLO_CONTINUA
		
FINAL_TEMPLO_1:
		
		ld		hl,FINAL												;carga PANTALLA
		ld		de,#1800
		call	depack_VRAM
		call	recbios
		ei
...
animacion_final:
		...
		jr.		animacion_final_recont
		
animacion_final_cont:
...
animacion_final_1:
		...
		CALL	ONSTRIG
		or		a
		jr.		z,animacion_final
			
		jr.		MENU

FINAL_TEMPLO_NIVEL_1:
		...
		jr.		FINAL_TEMPLO_NIVEL_1_CONTINUA
		
FINAL_TEMPLO_NIVEL_1_ESP:
...
FINAL_TEMPLO_NIVEL_1_CONTINUA:		
		...
		CALL	ONSTRIG
		or		a
		jr.		z,FINAL_TEMPLO_NIVEL_1_CONTINUA
...
POINT_de_acceso_a_fases:
		...
		dw	bloque_sanctuary_5
		dw	bloque_sanctuary_6
		dw	bloque_sanctuary_7
		dw	bloque_sanctuary_8
		dw	bloque_sanctuary_9
		dw	bloque_sanctuary_10
		dw	bloque_sanctuary_11
		dw	bloque_sanctuary_12
		dw	bloque_sanctuary_13
		dw	bloque_sanctuary_14
		dw	bloque_sanctuary_15
		dw	bloque_sanctuary_16
		dw	bloque_sanctuary_17
		dw	bloque_sanctuary_18
		dw	FINAL_TEMPLO
...
se__acabo:		db	64,242,228,64,64,64,224,226,224,225,74
continua_i:		db	229,197,64,64,64,64,226,238,237,243,232,237,244,228
continua_e:		db	229,197,64,64,64,64,226,238,237,243,232,237,156,224
...
copyright:		db	28,"(C)  CARAMBALpN STUDIOS 2018"
